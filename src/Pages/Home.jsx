           ...
           <Container>
             <section>
                <div className='text-center py-7'>
                     <h2 className='font-bold text-2xl md:text-3xl lg:text-4xl text-[#1B5E20] poppins-font'>🌻 Latest  <span className='text-[#F9A825]'>Crops </span></h2>
            <p className=' font-semibold text-lg  md:text-xl lg:text-xl text-gray-400 hind-siliguri-font mt-5'>Stay updated with the newest crops added to our collection. Check out what’s trending in the fields right now.</p>
                </div>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-8 md:py-10 lg:py-14'>
                         ...
                         <Link to='/all-crops' className='flex justify-center mb-12'>
